...
checkpoint_config = dict(interval=20, by_epoch=False, max_keep_ckpts=1)
log_config = dict(
    interval=1, hooks=[dict(type='TextLoggerHook', by_epoch=False)])
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = 'outputs/exp_009_ternary_official_r50_stage1_smoke20_fp32'
load_from = '/home/research/research/evidence3d/checkpoints/official/stream_petr_r50_flash_704_bs2_seq_90e.pth'
resume_from = None
workflow = [('train', 1)]
...
PROTOCOL_FILE = None
custom_imports = dict(
    imports=['evidence3d_plugin', 'hooks.freeze_except_hook'],
    allow_failed_imports=False)
custom_hooks = [
    dict(type='EvidenceTraceHook', interval=20),
    dict(
        type='FreezeExceptHook',
        trainable_patterns=[
            'ternary_branches', 'observability_head', 'evidence_step'
        ],
        priority='VERY_HIGH')
]
seed = 2026
