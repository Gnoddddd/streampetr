"""B0: clean-only original StreamPETR."""

_base_ = "./mini_observability_common.py"

work_dir = "outputs/stage3/observability_distillation/b0"
...
train_pipeline = [
    ...
    dict(type="ApplyPartialObservation", training=True, seed=2026, camera_crash_prob=0.0, frame_lost_prob=0.0, dark_prob=0.0, fog_prob=0.0, motion_blur_prob=0.0),
