...
output_root="$project_root/outputs/stage2/s2_4_baseline_disambiguation/eval"
...
modes=(c0 c1)
configs=(
  "$project_root/configs/evidence_conserving/mini_stage2_canonical_no_discount_50.py"
  "$project_root/configs/evidence_conserving/mini_stage2_legacy_fixed_discount_50.py"
)
checkpoints=(
  "$project_root/outputs/stage2/s2_4_baseline_disambiguation/c0_50/iter_50.pth"
  "$project_root/outputs/stage2/s2_4_baseline_disambiguation/c1_50/iter_50.pth"
)
...
printf 'S2.4 baseline disambiguation evaluation completed: %s\n' \
  "$output_root"
