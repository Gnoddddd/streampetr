...
CONFIG="$ROOT/configs/evidence_conserving/mini_ternary_official_r50_stage1_active_eval.py"
CHECKPOINT="$ROOT/outputs/exp_009_ternary_official_r50_stage1_200_fp32/iter_200.pth"
...
OUT_ROOT="$ROOT/outputs/stage1_r50_evidence_trace_v1"
...
TRACE_DIR="$EXP_DIR/evidence_trace"
