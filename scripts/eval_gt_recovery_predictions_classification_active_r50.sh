...
CONFIG="$ROOT/configs/evidence_conserving/mini_classification_official_r50_active_eval.py"
...
OUT_ROOT="$ROOT/outputs/gt_recovery_predictions/classification_active_r50_900q"
